...
/**
 * Created by wkhuahuo on 02/02/17.
 */
public class TreeToSequenceNonRecursiveTest {
    ...
    public void testInitTreeNode(){
        ...
        TreeToSequenceNonRecursive treeToSequenceNonRecursive = new TreeToSequenceNonRecursive();
        treeToSequenceNonRecursive.convert(root);
